...
import { UniversalQuizRenderer, QuestionData, QuizState } from "./universal-quiz-renderer"
      ...
      case 'question':
        ...
        return (
          <UniversalQuizRenderer
            ...
            onMediaEnd={() => {
              // Po skončení media přejít na revealed
              if (currentQuestion.type === 'audio' || currentQuestion.type === 'video') {
                setTimeout(() => setQuizState('revealed'), 1000)
              }
            }}
